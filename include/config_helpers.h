 ...
 */
static inline bool config_strcpy_safe(char *dest, const char *src, size_t dest_size) {
 ...
 */
static inline config_error_t config_validate_int_range(int value, int min, int max) {
 ...
 */
static inline void config_json_add_int(strbf_t *sb, const char *key, int value) {
    strbf_puts(sb, "\"");
    strbf_puts(sb, key);
    strbf_puts(sb, "\":");
 ...
 */
static inline void config_json_add_uint(strbf_t *sb, const char *key, unsigned int value) {
    strbf_puts(sb, "\"");
    strbf_puts(sb, key);
    strbf_puts(sb, "\":");
 ...
 */
static inline void config_json_add_string(strbf_t *sb, const char *key, const char *value) {
    strbf_puts(sb, "\"");
    strbf_puts(sb, key);
    strbf_puts(sb, "\":\"");
    strbf_puts(sb, value);
 ...
 */
static inline void config_json_add_bool(strbf_t *sb, const char *key, bool value) {
    strbf_puts(sb, "\"");
    strbf_puts(sb, key);
    strbf_puts(sb, "\":");
 ...
 */
const char *config_get_item_name(sconfig_group_t group, size_t index);
 ...
 * @return true on success, false on error
 */
bool config_get_item_description_str(sconfig_group_t group, size_t index, 
 ...
 */
sconfig_item_type_t config_get_item_type(sconfig_group_t group, size_t index);
 ...
 * @param group Configuration group
 */
void config_dump_group(sconfig_group_t group);
 ...
 */
void config_get_stats(size_t *total_items, size_t *total_size, size_t *rtc_size);
